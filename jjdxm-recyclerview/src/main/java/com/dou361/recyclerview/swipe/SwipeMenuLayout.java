...
public class SwipeMenuLayout extends FrameLayout implements SwipeSwitch {
    ...
    public SwipeMenuLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.recyclerview_swipemenulayout);
        mLeftViewId = typedArray.getResourceId(R.styleable.recyclerview_swipemenulayout_recyclerview_leftviewid, mLeftViewId);
        mContentViewId = typedArray.getResourceId(R.styleable.recyclerview_swipemenulayout_recyclerview_contentviewid, mContentViewId);
        mRightViewId = typedArray.getResourceId(R.styleable.recyclerview_swipemenulayout_recyclerview_rightviewid, mRightViewId);
        typedArray.recycle();
